...
<main id="main">
	...
	<section id="content">
		<section id="we-are">
			<div class="container">
				<div id="we-are-info">
					<h2>we are<br>portsmouth rha</h2>
					<p>
				...
				<div class="img-container">
					<div style="background:url('./_assets_/images/we-are1.jpg') center no-repeat;background-size:cover"></div>
					<div style="background:url('./_assets_/images/we-are2.jpg') center no-repeat;background-size:cover"></div>
					<div style="background:url('./_assets_/images/we-are3.jpg') center no-repeat;background-size:cover"></div>
				</div><!-- /.img-container -->
			</div><!-- /.container -->
		</section><!-- /#we-are -->
